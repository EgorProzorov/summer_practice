...
prepr(pd.read_csv("/Users/egorprozorov/Desktop/practice/data/save_init.csv"), "initial.csv")
prepr(pd.read_csv("/Users/egorprozorov/Desktop/practice/data/save_res.csv"), "result.csv")
